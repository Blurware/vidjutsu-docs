...
```
Video Intelligence API — critic, breakdown, and viral scoring for AI-generated video. (vidjutsu v0.1.0)

USAGE vidjutsu auth|account|post|critic|breakdown|score|status|balance|topup|chat|info
```
