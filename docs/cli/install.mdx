...
```
Video Intelligence API — watch, extract, transcribe, and check AI-generated video. (vidjutsu v0.1.0)

USAGE vidjutsu auth|watch|extract|transcribe|check|upload|account|post|balance|subscribe|status|info|session
```
