...
```
VidJutsu — clone viral videos onto your own characters. (vidjutsu v1.3.0)

USAGE vidjutsu clone|auth|check|upload|subscribe|status|version|update|watch|extract|transcribe|overlay|compliance|account|post|asset|reference|jobs|usage|info
```
