...
```json
{
  ...
  "reused": false,
  "metadata": {
    "caption": "A simple product demo #ugc",
    "authorHandle": "creator",
    "authorName": "Creator Name",
    "hashtags": ["ugc"],
    "postedAt": 1784736000000,
    "durationSeconds": 12,
    "coverUrl": "https://cdn.vidjutsu.ai/covers/123456789.jpg",
    "stats": {
      "views": 120000,
      "likes": 8400,
      "comments": 310,
...
Repeated imports of the same post reuse the same asset (`reused: true`) without
...
```json
{
  ...
  "evidence": [
    ...
    "No fast cuts or motion-critical occlusion"
  ],
  "model": "google/gemini-3.6-flash"
}
```

Gemini returns structured observations and the server applies a fixed rubric.
