...
- Informational only — not legal advice, and no freshness or accuracy guarantee. The citation reflects what we last ingested from the platform's own published text; you're expected to verify the live source before acting on the result. See [Terms of Service](/legal/terms)
