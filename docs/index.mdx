...
- **Fresh policies** — we re-ingest every platform's policy pages weekly so citations point at what the rulebook says *today*
- **Verbatim citations** — every violation links back to the platform's own policy page, with the exact quoted clause
- **Informational, not legal advice** — you still own the publish decision; we just surface what the platforms say
