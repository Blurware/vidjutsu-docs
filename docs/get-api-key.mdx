...
description: "Subscribe, save your API key, and start using VidJutsu"
---

## 1. Subscribe

VidJutsu requires a **$99/month subscription** for metered API operations. Daily limits apply to published endpoint groups, while storage and read-only operations are unmetered — see [Pricing & Rate Limits](/credits-and-billing). You can subscribe via the CLI or API.
