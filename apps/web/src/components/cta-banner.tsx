  ...
  return (
    <section className="px-5 sm:px-8 py-20 sm:py-28 border-t border-border">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-2xl sm:text-3xl font-bold tracking-[-0.02em] mb-4 max-w-2xl mx-auto">
          Plug the compliance gap in your video pipeline
        </h2>
        <p className="text-ink-muted text-sm sm:text-base mb-8 max-w-lg mx-auto">
          Start with one API key. $99 per month includes 1,000 credits — enough for roughly a hundred full video passes.
        </p>
