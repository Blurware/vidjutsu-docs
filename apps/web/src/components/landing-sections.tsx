      ...
      <section className="vj-difference" id="difference">
        <div className="vj-frame">
          ...
          <div className="vj-comparison-grid">
            ...
            <article className="with"><span>WITH VIDJUTSU</span><h3>Your agent ships the clone.</h3><ul><li>Score a video before generation</li><li>Put your own character in it</li><li>Get a finished clone back, ready to post</li><li>Post at the pace an agent works</li></ul><footer>ONE KEY · YOUR AGENT DOES IT</footer></article>
          </div>
        </div>
      </section>
