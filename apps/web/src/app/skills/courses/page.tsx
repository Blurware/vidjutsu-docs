    ...
    <main className="px-5 sm:px-8 py-16 sm:py-24">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-ink-muted text-base sm:text-lg leading-relaxed mb-14">
          ...
          Your agent runs the page &mdash; you supply the course material.
        </p>
        ...
        <section className="mb-14">
          ...
          <div className="space-y-4 max-w-2xl">
            {[
              {
                label: "Collects your course details",
                detail: "Course URL, topic, and target audience.",
              },
              {
                label: "Researches educational content in your niche",
                detail:
                  "Scrapes top-performing accounts to identify what converts viewers into students.",
              },
              {
              ...
              {
                label: "Drafts tip-based, preview, and testimonial content",
                detail:
